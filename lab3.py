...
def create_element(build_ele, doc):
    element = Element(doc).create(build_ele)
    return element
...
class Element:
    ...
    def create(self, build_ele):
        ...
        self.create_lower_part(build_ele)
    ...
    def connect_all_parts(self, build_ele):
        ...
        com_prop.Color = 3
        com_prop.Stroke = 1
        polyhedron_bottom = self.create_lower_part(build_ele)
        polyhedron_center = self.create_central_part(build_ele)
        polyhedron_top = self.create_top_part(build_ele)
    ...
    def create_lower_part(self, build_ele):
        polyhedron = self.lower_part_addiction1(build_ele)
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction4(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction2_2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction3_2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction4_2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction2_3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction3_3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction2_4(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.lower_part_addiction3_4(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.last_lower_part(build_ele))
        return polyhedron

    def create_top_part(self, build_ele):
        polyhedron = self.top_part_addiction1(build_ele)
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction3(build_ele, plus=(build_ele.Length.value - build_ele.LengthCenterWidth.value)))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction4(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction2_2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction4(build_ele, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2, build_ele.WidthTop.value, 10))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction2_3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction4_2(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction4_2(build_ele, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2, build_ele.WidthTop.value, 10))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.top_part_addiction3_3(build_ele))
        err, polyhedron = AllplanGeo.MakeUnion(polyhedron, self.last_top_part(build_ele))
        return polyhedron

    def create_central_part(self, build_ele):
    ...
    def top_part_addiction1(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, 
                                        build_ele.WidthBottom.value - build_ele.LengthBottomCut.value - (build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2 - build_ele.WidthCentralLittle.value) / 2,
    ...
    def top_part_addiction2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction3(self, build_ele, plus=0):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction4(self, build_ele, minus_1 = 0, minus_2 = 0, digit = -10):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction2_2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction2_3(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction4_2(self, build_ele, minus_1 = 0, minus_2 = 0, digit = -10):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def top_part_addiction3_3(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def lower_part_addiction1(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def lower_part_addiction2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
    ...
    def lower_part_addiction3(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def lower_part_addiction4(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value + (build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2 - build_ele.WidthCentralLittle.value) / 2, build_ele.WidthBottom.value, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
    ...
    def lower_part_addiction2_2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def lower_part_addiction3_2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
    ...
    def lower_part_addiction4_2(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value, 0, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
        base_pol += AllplanGeo.Point3D(build_ele.LengthCenterWidth.value + (build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2 - build_ele.WidthCentralLittle.value) / 2, 0, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
    ...
    def lower_part_addiction2_3(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
    ...
    def lower_part_addiction3_3(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value - build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, build_ele.WidthBottom.value, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value - (build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2 - build_ele.WidthCentralLittle.value) / 2, build_ele.WidthBottom.value, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
    ...
    def lower_part_addiction2_4(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
    ...
    def lower_part_addiction3_4(self, build_ele):
        base_pol = AllplanGeo.Polygon3D()
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, build_ele.LengthBottomCut.value, build_ele.HeightBottom.value)
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value, 0, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
        base_pol += AllplanGeo.Point3D(build_ele.Length.value - build_ele.LengthCenterWidth.value - (build_ele.WidthBottom.value - build_ele.LengthBottomCut.value * 2 - build_ele.WidthCentralLittle.value) / 2, 0, build_ele.HeightBottom.value - build_ele.HeightBottomCut.value)
